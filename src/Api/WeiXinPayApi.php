...
class WeiXinPayApi extends WeiXinApi
{
    ...
    public function business_transfer($data){
        if (
            !isset($this->config['apiclient_cert_path']) || !isset($this->config['apiclient_key_path']) ||
            !is_file($this->config['apiclient_cert_path']) || !is_file($this->config['apiclient_key_path'])
        )throw new \Exception('apiclient_cert_path and apiclient_key_path must be exists');
        ...
        curl_setopt($ch,CURLOPT_SSLCERT,$this->config['apiclient_cert_path']);
        /*curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');*/
        curl_setopt($ch,CURLOPT_SSLKEY,$this->config['apiclient_key_path']);
